    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paper_count', models.IntegerField(default=0, verbose_name='عدد الافرخ')),
                ('paper_sal', models.DecimalField(decimal_places=1, default=Decimal('0'), max_digits=15, verbose_name='السعر')),
                ...
                ('print_count_one', models.DecimalField(decimal_places=1, default=Decimal('0'), max_digits=15)),
                ('print_count_two', models.DecimalField(decimal_places=1, default=Decimal('0'), max_digits=15)),
                ...
                ('slofan_count', models.DecimalField(decimal_places=1, default=Decimal('0'), max_digits=15)),
                ('uv', models.CharField(blank=True, max_length=50)),
                ('uv_ckb', models.BooleanField(default=False)),
                ('uv_count', models.DecimalField(decimal_places=1, default=Decimal('0'), max_digits=15)),
                ...
                ('taksir_count', models.DecimalField(decimal_places=1, default=Decimal('0'), max_digits=15)),
                ...
                ('aklasheh_sal', models.DecimalField(decimal_places=1, default=Decimal('0'), max_digits=15)),
                ...
                ('taglid_count', models.DecimalField(decimal_places=1, default=Decimal('0'), max_digits=15)),
                ('taglid_sal', models.DecimalField(decimal_places=1, default=Decimal('0'), max_digits=15)),
