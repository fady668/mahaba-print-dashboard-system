...
class Invoise(models.Model):
    ...
    paper_sal = models.DecimalField(max_digits=15, decimal_places=1, verbose_name="السعر", default=Decimal(0.00), blank=True, null=True)
    ...
    zenk_sal = models.DecimalField(max_digits=15, decimal_places=1, default=Decimal(42.5))
    # Print
    print_count_one = models.DecimalField(max_digits=15, decimal_places=1, default=Decimal(0.00), blank=True, null=True)
    print_count_two = models.DecimalField(max_digits=15, decimal_places=1, default=Decimal(0.00), blank=True, null=True)
    ...
    slofan_count = models.DecimalField(max_digits=15, decimal_places=1, default=Decimal(0.00), blank=True, null=True)
    uv = models.CharField(max_length=50, blank=True)
    uv_ckb = models.BooleanField(default=False)
    uv_count = models.DecimalField(max_digits=15, decimal_places=1, default=Decimal(0.00), blank=True, null=True)
    taksir = models.CharField(max_length=50, blank=True, choices=TAKSIR_CHOICES)
    taksir_ckb = models.BooleanField(default=False)
    taksir_count = models.DecimalField(max_digits=15, decimal_places=1, default=Decimal(0.00), blank=True, null=True)
    ...
    aklasheh_sal = models.DecimalField(max_digits=15, decimal_places=1, default=Decimal(0.00), blank=True, null=True)
    ...
    taglid_count = models.DecimalField(max_digits=15, decimal_places=1, default=Decimal(0.00), blank=True, null=True)
    taglid_sal = models.DecimalField(max_digits=15, decimal_places=1, default=Decimal(0.00), blank=True, null=True)
