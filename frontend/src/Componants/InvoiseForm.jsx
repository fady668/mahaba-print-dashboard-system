    ...
    return (
        <>
            <form onSubmit={() => postInvoise()}>
                ...
                <div className="form-invoise-con paper-sec">
                    ...
                    <div className="inner-con">
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setPaper_count_before(e.target.value)
                            }
                    ...
                    <div className="inner-con">
                        ...
                        {paper_type_one === "كوشيه" ? (
                            <select
                                ...
                                onChange={(e) =>
                                    setPaper_type_two(e.target.value)
                                }>
                                <option value="" selected></option>
                            ...
                            <select
                                ...
                                <option value="" selected></option>
                                <option value="بلاستيك ابيض">
                                    بلاستيك ابيض
                                </option>
                                <option value="بلاستيك شفاف">
                                    بلاستيك شفاف
                                </option>
                ...
                <div className="form-invoise-con">
                    ...
                    <div className="inner-con">
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setZenk_count_before(e.target.value)
                            }
                    ...
                    <div className="form-invoise-con">
                        <div className="inner-con colors">
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setColor_back_k(e.target.checked)
                                }
                                name="color_back_k"
                            />
                            <input
                                ...
                                onChange={(e) =>
                                    setColor_back_m(e.target.checked)
                                }
                                name="color_back_m"
                            />
                            <input
                                ...
                                onChange={(e) =>
                                    setColor_back_y(e.target.checked)
                                }
                                name="color_back_y"
                            />
                            <input
                                ...
                                onChange={(e) =>
                                    setColor_back_c(e.target.checked)
                                }
                                name="color_back_c"
                            />
                            <input
                                ...
                                onChange={(e) =>
                                    setColor_back_zahabi(e.target.checked)
                                }
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setColor_back_faddi(e.target.checked)
                                }
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setColor_back_sabgha(e.target.checked)
                                }
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setColor_back_warnish(e.target.checked)
                                }
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setColor_back_kohley(e.target.checked)
                                }
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setColor_back_special(e.target.value)
                                }
                ...
                <h1 className="heighlight-text form-heading">
                    التجليد والتشطيب
                </h1>
                ...
                <div>
                    <div className="form-invoise-con borderd padding">
                        ...
                        <select
                            ...
                            <option value="اول + وسط + اخير">
                                اول + وسط + اخير
                            </option>
                            <option value="اول + 2وسط + اخير">
                                اول + 2وسط + اخير
                            </option>
                            <option value="اول + 3وسط + اخير">
                                اول + 3وسط + اخير
                            </option>
                        </select>
                        <div className="inner-con">
                    ...
                    <div className="form-invoise-con">
                        <div className="inner-con fit">
                            ...
                            <input
                                ...
                                checked={slofan_ckb}
                                onChange={(e) =>
                                    setSlofan_ckb(e.target.checked)
                                }
                                name="slofan_ckb"
                            />
                            <select
                        ...
                        <div className="inner-con fit">
                            ...
                            <input
                                ...
                                value={slofan_count}
                                onChange={(e) =>
                                    setSlofan_count(e.target.value)
                                }
                            />
                        </div>
                    </div>
                    ...
                    <div className="form-invoise-con">
                        <div className="inner-con fit">
                            ...
                            <input
                                ...
                                checked={taksir_ckb}
                                onChange={(e) =>
                                    setTaksir_ckb(e.target.checked)
                                }
                                name="taksir_ckb"
                            />
                            <select
                        ...
                        <div className="inner-con fit">
                            ...
                            <input
                                ...
                                value={taksir_count}
                                onChange={(e) =>
                                    setTaksir_count(e.target.value)
                                }
                            />
                        </div>
                        <div className="inner-con fit">
                    ...
                    <div className="form-invoise-con">
                        <div className="inner-con fit">
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setAklasheh_ckb(e.target.checked)
                                }
                                name="aklasheh_ckb"
                            />
                            <select
                        ...
                        <div className="inner-con fit">
                            ...
                            <input
                                ...
                                value={aklasheh_sal}
                                onChange={(e) =>
                                    setAklasheh_sal(e.target.value)
                                }
                            />
                        </div>
                        <div className="inner-con fit">
                    ...
                    <div className="form-invoise-con">
                        <div className="inner-con fit">
                            ...
                            <input
                                ...
                                checked={taglid_ckb}
                                onChange={(e) =>
                                    setTaglid_ckb(e.target.checked)
                                }
                                name="taglid_ckb"
                            />
                            <select
                        ...
                        <div className="inner-con fit">
                            ...
                            <input
                                ...
                                value={taglid_count}
                                onChange={(e) =>
                                    setTaglid_count(e.target.value)
                                }
                            />
                        </div>
                        <div className="inner-con fit">
                    ...
                    <div className="form-invoise-con">
                        <div className="inner-con fit">
                            ...
                            <input
                                ...
                                checked={tawdib_ckb}
                                onChange={(e) =>
                                    setTawdib_ckb(e.target.checked)
                                }
                                name="tawdib_ckb"
                            />
                            <input
                        ...
                        <div className="inner-con fit">
                            ...
                            <input
                                ...
                                checked={tasmim_ckb}
                                onChange={(e) =>
                                    setTasmim_ckb(e.target.checked)
                                }
                                name="tasmim_ckb"
                            />
                            <input
                    ...
                    <div className="form-invoise-con">
                        ...
                        <div className="inner-con fit">
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setKhadamat_ckb(e.target.checked)
                                }
                                name="khadamat_ckb"
                            />
                            <input
            ...
            {showSals && (
                <>
                    <div
                        id="sals-form"
                        className="over-layout invoise-sals-layout"></div>
